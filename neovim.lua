...
local function apply()
  ...
  hi("Directory",    { fg = colors.acc })

  hi("DiagnosticError", { fg = "#ff7a66" })
  hi("DiagnosticWarn",  { fg = colors.yellow })
  hi("DiagnosticInfo",  { fg = colors.tan })
  ...
  hi("Underlined",  { fg = colors.tan, underline = true })
  ...
  hi("RenderMarkdownH4",   { fg = colors.green,  bg = dim_bg, bold = true })
  hi("RenderMarkdownH5",   { fg = colors.cyan,   bg = dim_bg, bold = true })
  ...
  hi("RenderMarkdownLink",   { fg = colors.tan, underline = true })
